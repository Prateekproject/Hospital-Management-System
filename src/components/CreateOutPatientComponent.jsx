...
class CreateOutPatientComponent extends Component {
    ...
    //             let outpatient = res.data;
    //             this.setState
    //             ({patientName: outpatient.patientName,
    //                 sfName: outpatient.sfName,
    //                 gender: outpatient.gender,
    //                 age :outpatient.age,
    //                 city :outpatient.city,
    //                 malady :outpatient.malady,
    ...
    savePatient = (e) => {
        e.preventDefault();
        let outpatient = {patientName: this.state.patientName, sfName: this.state.sfName, gender: this.state.gender ,age: this.state.age, city: this.state.city, malady: this.state.malady, category: this.state.category};
        console.log('outpatient => ' + JSON.stringify(outpatient));

        // step 5
        
            PatientService.createOutPatient(outpatient).then(res =>{
